                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <form action="<?php echo site_url("konsultasi/pertanyaan") ?>" method="post">
                      ...
                      <label for="">Umur</label><input type="number" name="umur" required> <br>
                      ...
                      <label for="">Alamat Depot</label>
                      <select name="alamat" class="form-control" style="display:block" required>
                        <option value="">--Pilih Alamat Depot--</option>
                        <?php
                        foreach ($data_depot as $k) {
                          echo "<option value='$k->nama_depot'>$k->nama_depot</option>";
                        }
                        ?>
                      </select>
