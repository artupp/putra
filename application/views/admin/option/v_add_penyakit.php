            ...
            <div class="col-lg-12">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <div class="form">
                            <form action="<?= base_url('a_penyakit/tambahPenyakit'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="" class="control-label col-lg-2">Masukan Foto</label>
                                ...
                                <div class="form-group">
                                    <div class="control-label col-lg-2">
                                        <button class="btn btn-outline btn-success" type="submit" name="hasil">Simpan</button>
                                    </div>
                                    <div class="control-label col-lg-2">
